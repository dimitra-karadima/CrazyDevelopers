...
public class Exceptions {
	String x;
	/*Method that reads the choice of the user
	*and checks to see if the value of the choice
	*produces the InputMismatchException and
	*ends when the value is valid and no Exception is thrown*/
	...
	/*Method that checks if the value that the user gives
	*throws the InputMismatchException or the ArrayOutOfBoundsException
	*and ends when none of the above Exceptions are thrown*/
	...
	/*Method used for the same reason but with one more argument
	*because we need to get to second dimension of the array lists*/
	...
	/*Method used for the same reason but with different arguments
	*because we need to use the features for every list*/
